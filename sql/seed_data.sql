...
(UUID(), (SELECT id FROM users WHERE email = 'maestropanadero96@hbnb.io'), (SELECT id FROM places WHERE title = 'Cabin in the Woods'), 4.0, 'Smells nice in the morning, avoid the guy with a chainsaw', NOW(), NOW()),
(UUID(), (SELECT id FROM users WHERE email = 'redrogsoviet@hbnb.io'), (SELECT id FROM places WHERE title = 'Modern Loft in San Francisco'), 3.5, 'Great place, you almost forget about all the junkies in the street', NOW(), NOW()),
(UUID(), (SELECT id FROM users WHERE email = 'minecraft6969@hbnb.io'), (SELECT id FROM places WHERE title = 'Villa in Tuscany'), 5.0, 'Absolutely stunning villa!', NOW(), NOW()),
(UUID(), (SELECT id FROM users WHERE email = 'admin@hbnb.io'), (SELECT id FROM places WHERE title = 'Penthouse in Tokyo'), 1.0, 'Tokyo sucks!!!', NOW(), NOW()),
